    ...
    <div className={cn("relative isolate", className)}>
      <div
        className={cn(
          ...
          "border-r-[600px] lg:border-r-[700px] xl:border-r-[400px] border-r-transparent",
          "border-t-[600px] lg:border-t-[700px] xl:border-t-[600px] border-t-[color:var(--orb-color-dark)]",
        )}
      />
      <div
        className={cn(
          ...
          "border-t-[2.125rem] md:border-t-[3.125rem] lg:border-t-[2.125rem] border-t-[rgba(255,255,255,0.12)]",
        )}
      />
      {children}
    </div>
